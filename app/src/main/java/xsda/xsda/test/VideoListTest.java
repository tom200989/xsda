...
public class VideoListTest {
    ...
    public static List<VideoListItemBean> testData(Activity activity) {
        // TODO: 2019/5/22 0022 ----------------测试设置数据----------------
        List<VideoListItemBean> videolists = new ArrayList<>();
        for (int i = 0; i < 10; i++) {
            VideoListItemBean itemBean = new VideoListItemBean();
